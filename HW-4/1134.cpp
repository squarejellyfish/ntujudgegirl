  ...
  public:
    ...
    void pickup(char type, char name[])
    {
        ...
        else if (type == 'e')
        {
            if (ne == 5)
            {
                cout << "Equipment capacity full, pickup failed.\n";
            }
            else
            {
                for (int i = 0; i < 5; i++)
                {
                    if (strcmp(Equipment[i], "") == 0)
                    {
        ...
        else if (type == 'i')
        {
            if (ni == 5)
            {
                cout << "Item capacity full, pickup failed.\n";
            }
            else
            {
                for (int i = 0; i < 5; i++)
    ...
    void drop(char type, char name[])
    {
        ...
        if (type == 'w')
        {
            if (nw == 0)
            {
                cout << "Weapon bag empty, nothing to toss.\n";
            }
            else
            {
                int sus = 0;
        ...
        else if (type == 'e')
        {
            if (ne == 0)
            {
                cout << "Equipment bag empty, nothing to toss.\n";
            }
            else
            {
                int sus = 0;
        ...
        else if (type == 'i')
        {
            if (ni == 0)
            {
                cout << "Item bag empty, nothing to toss.\n";
            }
            else
            {
                int sus = 0;
